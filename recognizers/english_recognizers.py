...
class EnglishRecognizers(BaseRecognizer):
    """English-specific PII recognizers"""
    ...
    def _get_entity_types(self) -> List[str]:
        """Get all supported English entity types"""
        return [
            "CRYPTO_WALLET",
            "MEDICAL_LICENSE", 
    ...
    def _create_nrp_recognizer(self) -> PatternRecognizer:
        """Nationality, Religious, Political group indicators"""
        patterns = [
            Pattern(
